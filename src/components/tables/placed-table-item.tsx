...
const PlacedTableItem = memo(
  ({
    ...
    const handleResizePointerMove = (e: React.PointerEvent) => {
      ...
      const dist = Math.hypot(e.clientX - cx, e.clientY - cy) / zoom
        ...
        >
          ...
          >
            <img
              ...
              className="size-full object-contain pointer-events-none transition-[filter] duration-300 will-change-transform"
            />
          </div>
